...
bucket_name="rym-demo-bucket-zyx-1234567890"
lambda_func_name="s3-lambda-function"
role_name="s3-lambda-sns"
email_address="sample-mail@gmail.com"
...
aws sns publish \
  ...
  --message "Hello from Raiyan Yousuf! A new object has been created in the S3 bucket: $bucket_name. Please check the bucket for the new object."
